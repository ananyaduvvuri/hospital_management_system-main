...
// Add this function to retrieve past appointments
// Add this function to add an appointment to the past_appointments table
// Add this function to handle adding an appointment to past_appointments
// Add this function to handle adding an appointment to past_appointments
// Update the addPastAppointment function in db_controller.js
// Add this function to handle adding an appointment to past_appointments
...
// Add this function to add an appointment to the past_appointments table
module.exports.addPastAppointment = function (
  id,
  patient_name,
  department,
  doctor_name,
  ...
  var query =
    "INSERT INTO past_appointments (id,patient_name, department, doctor_name, date, time, email, phone) " +
    "VALUES (?, ?, ?, ?, ?, ?, ?,?)";

  con.query(query, [id,patient_name, department, doctor_name, date, time, email, phone], callback);
};


// Add this function to delete an appointment from the appointments table
